...
export const users: UserRow[] = [
  {
    name: "Olivia Rhye",
    email: "olivia.rhye@imperium-growth.com",
    role: "Workspace Owner",
    status: "Active",
    team: "Platform",
    workspace: ["Imperium Growth", "Internal Tools"],
    joinedDate: "24 Jun 2024, 9:23 AM",
    lastActive: 0,
  },
  {
    name: "Phoenix Baker",
    email: "phoenix.baker@imperium-growth.com",
    role: "Admin",
    status: "Active",
    team: "Growth",
    workspace: ["Imperium Growth"],
  ...
  {
    name: "Demi Wilkinson",
    email: "demi.wilkinson@imperium-growth.com",
    role: "Security Admin",
    status: "Locked",
    team: "Internal Tools",
    workspace: ["Imperium Growth", "Internal Tools"],
  ...
  {
    name: "Natali Craig",
    email: "natali.craig@imperium-growth.com",
    role: "Contributor",
  ...
  {
    name: "Andi Lane",
    email: "andi.lane@imperium-growth.com",
    role: "Contributor",
    status: "Active",
    team: "People Ops",
    workspace: ["Imperium Growth", "Sandbox"],
    joinedDate: "04 Nov 2022, 9:50 AM",
    lastActive: 12,
  },
  {
    name: "Kate Morrison",
    email: "kate.morrison@imperium-growth.com",
    role: "Admin",
    status: "Active",
    team: "Platform",
    workspace: ["Imperium Growth"],
  ...
  {
    name: "Ariana Decker",
    email: "ariana.decker@imperium-growth.com",
    role: "Contributor",
    status: "Active",
    team: "Growth",
    workspace: ["Imperium Growth"],
  ...
  {
    name: "Koray Okumus",
    email: "koray.okumus@imperium-growth.com",
    role: "Security Admin",
    status: "Active",
    team: "Internal Tools",
    workspace: ["Imperium Growth", "Internal Tools"],
  ...
  {
    name: "Mollie Hall",
    email: "mollie.hall@imperium-growth.com",
    role: "Contributor",
    status: "Deactivated",
    team: "Platform",
    workspace: ["Imperium Growth"],
  ...
  {
    name: "Sienna Hewitt",
    email: "sienna.hewitt@imperium-growth.com",
    role: "Admin",
    status: "Active",
    team: "Internal Tools",
    workspace: ["Imperium Growth", "Internal Tools"],
  ...
  {
    name: "Noah Pierre",
    email: "noah.pierre@imperium-growth.com",
    role: "Contributor",
    status: "Active",
    team: "Platform",
    workspace: ["Imperium Growth"],
  ...
  {
    name: "Mia Romberg",
    email: "mia.romberg@imperium-growth.com",
    role: "Billing Admin",
    status: "Pending invite",
    team: "Finance",
    workspace: ["Imperium Growth"],
...
export const filters = {
  ...
  workspace: ["All", "Imperium Growth", "Sandbox", "Internal Tools", "Acme Inc."],
};
