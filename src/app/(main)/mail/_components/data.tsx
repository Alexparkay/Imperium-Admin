...
const alexKaymakanov = {
  name: "Alex Kaymakanov",
  email: "Alex@imperium-growth.com",
};

const imperiumGrowth = {
  name: "Imperium Growth",
  email: "contact@imperium-growth.com",
};
...
export const mails: Mail[] = [
  {
    ...
    attachments: [
      {
        id: "imperium-admin-fig",
        name: "imperium-admin.fig",
        size: "21 MB",
        icon: siFigma,
      },
      {
...
export const accounts = [
  {
    id: 1,
    label: "Alex Kaymakanov",
    email: "Alex@imperium-growth.com",
  },
  {
    id: 2,
    label: "Imperium Growth",
    email: "contact@imperium-growth.com",
  },
];
